...
file(WRITE ${OUTPUT_HEADER_FILE} "${headerBeginString}\n")
file(WRITE ${OUTPUT_LIST_FILE} "/* Auto generated include list */\n")
foreach(HEADER_FILE IN LISTS HEADER_FILES)
    ...
    file(APPEND ${OUTPUT_HEADER_FILE} "${EXTRACTED_BEGIN}\n")
    ...
    file(APPEND ${OUTPUT_HEADER_FILE} "${EXTRACTED_END}\n")
    file(APPEND ${OUTPUT_LIST_FILE} "#include \"${HEADER_FILE}\"\n")
endforeach()
file(READ ${HEADER_FILE_END} headerBeginString)
file(APPEND ${OUTPUT_HEADER_FILE} "${headerBeginString}")
