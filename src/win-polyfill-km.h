...
typedef __drv_sameIRQL __drv_functionClass(RTL_AVL_COMPARE_ROUTINE)
...
typedef __drv_sameIRQL __drv_functionClass(RTL_AVL_FREE_ROUTINE)
...
typedef __drv_sameIRQL __drv_functionClass(RTL_AVL_MATCH_FUNCTION)
...
PVOID NTAPI RtlAllocateHeap(_In_ PVOID HeapHandle, _In_opt_ ULONG Flags, _In_ SIZE_T Size);
#endif
