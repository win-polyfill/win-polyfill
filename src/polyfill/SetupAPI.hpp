...
{
    static constexpr const GUID PropertyId = {
    ...
    if (memcmp(&PropertyKey->fmtid, &PropertyId, sizeof(PropertyId)) != 0 ||
        PropertyKey->pid < IndexStart ||
        PropertyKey->pid >= _countof(PropertyIdTypeIndex) + IndexStart)
    {
        return -1;
    }
...
static int __fastcall ClassPropertyKeyToPropertyType(
    CONST DEVPROPKEY *PropertyKey,
    _Out_ DEVPROPTYPE *PropertyType)
{
    static constexpr const GUID PropertyId = {
        0x4321918b, 0xf69e, 0x470d, {0xa5, 0xde, 0x4d, 0x88, 0xc7, 0x5a, 0xd2, 0x4b}};
    ...
    _In_ DWORD Flags)
{
    ...
    {
        return pSetupDiGetDevicePropertyW(
            DeviceInfoSet,
            DeviceInfoData,
            PropertyKey,
            PropertyType,
    ...
    _In_ DWORD Flags)
{
    ...
    {
        return pSetupDiSetDevicePropertyW(
            DeviceInfoSet,
            DeviceInfoData,
            PropertyKey,
            PropertyType,
    ...
    _In_ DWORD Flags)
{
    ...
    {
        return pSetupDiGetClassPropertyW(
            ClassGuid,
            PropertyKey,
            PropertyType,
            PropertyBuffer,
    ...
    _Reserved_ PVOID Reserved)
{
    ...
    {
        return pSetupDiGetClassPropertyExW(
            ClassGuid,
            PropertyKey,
            PropertyType,
            PropertyBuffer,
    ...
    _In_ DWORD Flags)
{
    ...
    {
        return pSetupDiSetClassPropertyW(
    ...
    _Reserved_ PVOID Reserved)
{
    ...
    {
        return pSetupDiSetClassPropertyExW(
            ClassGuid,
            PropertyKey,
            PropertyType,
            PropertyBuffer,
