    ...
    _In_ DWORD cbData)
{
    ...
    {
        HKEY hSubKey;
        auto lStatus = RegCreateKeyExW(
            hKey, lpSubKey, 0, nullptr, 0, KEY_SET_VALUE, nullptr, &hSubKey, nullptr);
...
// Windows Vista, Windows XP Professional x64 Edition, Windows Server 2008, Windows Server 2003 with
// SP1
__DEFINE_THUNK(
    advapi32,
    28,
    ...
    LPDWORD pcbData)
{
    ...
    if (pvData && pcbData == nullptr || (dwFlags & RRF_RT_ANY) == 0)
    {
