...
static FastDownlevelCallbackInfo *__fastcall GetFastDownlevelCallbackInfo()
{
...
__forceinline static FastDownlevelCallbackInfo
    *__fastcall TryLockFastDownlevelCallbackInfo(Fun Callback, Type UserData)
{
    if (!Callback)
        return nullptr;
    ...
    if (InterlockedCompareExchangePointer(
            &pFastDownlevelCallback->pRawPoint, (PVOID)Callback, nullptr) == nullptr)
    {
...
__forceinline static void __fastcall UnlockFastDownlevelCallbackInfo(
    FastDownlevelCallbackInfo *pFastCallbackInfo)
{
...
static LPCWSTR __fastcall DownlevelNeutralToSpecificLocaleName(LPCWSTR szLocaleName)
{
    ...
    static constexpr NeutralToSpecific NeutralToSpecificMap[] = {
        ...
        {L"zh-Hans", L"zh-CN"},      {L"zh-Hant", L"zh-HK"},
        {L"zu", L"zu-ZA"},
    };
    ...
    while (bottom <= top)
    {
        ...
        int testIndex = __wcsnicmp_ascii(
            szLocaleName, NeutralToSpecificMap[middle].szNeutralLocale, LOCALE_NAME_MAX_LENGTH);
...
static bool __fastcall AddLangIDToBuffer(
    LANGID *LocaleBuffer,
    const ULONG BufferCount,
    ULONG &Count,
    const LANGID New)
{
    // 空间不足
...
__DEFINE_THUNK(kernel32, 8, LCID, WINAPI, LocaleNameToLCID, _In_ LPCWSTR lpName, _In_ DWORD dwFlags)
{
    ...
    _In_ LPARAM lParam)
{
    ...
    do
    {
        ...
        auto pFastCallbackInfo =
            internal::TryLockFastDownlevelCallbackInfo(pCalInfoEnumProcExEx, lParam);
        ...
        if (pFastCallbackInfo)
        {
            lpCalInfoEnumProcEx = [](LPWSTR lpCalendarInfoString, CALID Calendar) {
                ...
                return pFastCallbackInfo->pCalInfoEnumProcExEx(
                    lpCalendarInfoString, Calendar, nullptr, pFastCallbackInfo->lParam);
            };
        }
        else
        {
            ...
            static constexpr const byte ThunkData[] = {
                ...
                // Calendar             = 08h + 8h
                0x68, 0x00, 0x00,
                0x00, 0x00, // push    lParam                              ; lParam
                0x6A, 0x00, // push    0                                   ; lpReserved
                0xFF, 0x74, 0x24,
                0x10, // push    dword ptr Calendar[esp]             ; Calendar
                0xFF, 0x74, 0x24,
                0x10, // push    dword ptr lpCalendarInfoString[esp] ; lpCalendarInfoString

                0xB8, 0x00, 0x00,
                0x00, 0x00,       // mov     eax, pCalInfoEnumProcExEx
                0xFF, 0xD0,       // call    eax
            ...
            static constexpr const byte ThunkData[] = {
                ...
                // Calendar             = edx
                0x49, 0xB9, 0x00, 0x00, 0x00,
                0x00, 0x00, 0x00, 0x00, 0x00, // mov     r9, lParam
                0x45, 0x33, 0xC0,             // xor     r8d, r8d                 ; lpReserved

                0x48, 0xB8, 0x00, 0x00, 0x00,
                0x00, 0x00, 0x00, 0x00, 0x00, // mov     rax, pCalInfoEnumProcExEx
                0xFF, 0xE0,                   // jmp     rax
            };
#endif

            auto pFun =
                (byte *)VirtualAlloc(nullptr, sizeof(ThunkData), MEM_COMMIT, PAGE_READWRITE);
        ...
        auto bSuccess = EnumCalendarInfoExW(lpCalInfoEnumProcEx, Locale, Calendar, CalType);
    ...
    _In_ LPARAM lParam)
{
    ...
    do
    {
        ...
        auto pFastCallbackInfo =
            internal::TryLockFastDownlevelCallbackInfo(lpDateFmtEnumProcExEx, lParam);
        ...
        if (pFastCallbackInfo)
        {
            lpDateFmtEnumProcEx = [](LPWSTR lpDateFormatString, CALID CalendarID) {
                ...
                return pFastCallbackInfo->lpDateFmtEnumProcExEx(
                    lpDateFormatString, CalendarID, pFastCallbackInfo->lParam);
            };
        }
        else
        {
            ...
            static constexpr const byte ThunkData[] = {
                ...
                0x00, 0x00, // push    lParam                              ; lParam
                0xFF, 0x74, 0x24,
                0x0C, // push    dword ptr CalendarID[esp]           ; CalendarID
                0xFF, 0x74, 0x24,
                0x0C, // push    dword ptr lpDateFormatString[esp]   ; lpDateFormatString

                0xB8, 0x00, 0x00,
                0x00, 0x00,       // mov     eax, lpDateFmtEnumProcExEx
                0xFF, 0xD0,       // call    eax
                0xC2, 0x08, 0x00, // retn    8
            };
#elif defined(_AMD64_)
            ...
            static constexpr const byte ThunkData[] = {
                ...
                0x00, 0x00, 0x00, 0x00, 0x00, // mov     r8, lParam

                0x48, 0xB8, 0x00, 0x00, 0x00,
                0x00, 0x00, 0x00, 0x00, 0x00, // mov     rax, lpDateFmtEnumProcExEx
                0xFF, 0xE0,                   // jmp     rax
            };
#endif
        ...
        auto bSuccess = EnumDateFormatsExW(lpDateFmtEnumProcEx, Locale, dwFlags);
    ...
    _In_opt_ LPVOID lpReserved)
{
    ...
    do
    {
        ...
        auto pFastCallbackInfo =
            internal::TryLockFastDownlevelCallbackInfo(lpLocaleEnumProcEx, lParam);
        ...
        if (pFastCallbackInfo)
        {
            ...
            lpLocaleEnumProc = [](LPWSTR lpLocaleString) -> BOOL {
                ...
                return pFastCallbackInfo->lpLocaleEnumProcEx(
                    lpLocaleString, 0, pFastCallbackInfo->lParam);
            };
        }
        else
        {
            ...
            static constexpr const byte ThunkData[] = {
                ...
                0xFF, 0x74, 0x24,
                0x0C, // push    dword ptr lpLocaleString[esp]       ; lpLocaleString

                0xB8, 0x00, 0x00,
                0x00, 0x00,       // mov     eax, lpLocaleEnumProcEx
                0xFF, 0xD0,       // call    eax
    ...
    _Inout_ PULONG pcchLanguagesBuffer)
{
    ...
    {
        return pGetThreadPreferredUILanguages(
    ...
    do
    {
        ...
        if (dwFlags & ~(MUI_LANGUAGE_ID | MUI_LANGUAGE_NAME | MUI_MERGE_SYSTEM_FALLBACK |
                        MUI_MERGE_USER_FALLBACK | MUI_THREAD_LANGUAGES))
        {
            lStatus = ERROR_INVALID_PARAMETER;
            break;
        }
        ...
        if ((dwFlags & (MUI_LANGUAGE_ID | MUI_LANGUAGE_NAME)) ==
        ...
        if ((dwFlags & (MUI_MERGE_USER_FALLBACK | MUI_MERGE_SYSTEM_FALLBACK)) &&
            (dwFlags & MUI_THREAD_LANGUAGES))
        {
            lStatus = ERROR_INVALID_PARAMETER;
            break;
        }
        ...
        if ((dwFlags &
             (MUI_MERGE_SYSTEM_FALLBACK | MUI_MERGE_USER_FALLBACK | MUI_THREAD_LANGUAGES)) == 0)
        {
        ...
        if ((dwFlags & (MUI_MERGE_USER_FALLBACK | MUI_THREAD_LANGUAGES)))
        {
            ...
            if (dwFlags & MUI_MERGE_SYSTEM_FALLBACK)
            {
                ...
                {
                    internal::AddLangIDToBuffer(
                        LanguageIds, _countof(LanguageIds), ulNumLanguages, LangID);
                }
            }
        }
        ...
        else
        {
            ...
            {
                wchar_t
                    szLanguageNameStaticBuffer[LOCALE_NAME_MAX_LENGTH * _countof(LanguageIds) + 1];

                // 如果目标缓冲区足够容纳，那么我们直接使用目标缓冲区，否则我们先使用
                // szLanguageNameStaticBuffer 中转。
                wchar_t *pBuffer = LOCALE_NAME_MAX_LENGTH * ulNumLanguages + 1 <= cchLanguagesBuffer
                                       ? pwszLanguagesBuffer
                                       : szLanguageNameStaticBuffer;
                auto pTmp = pBuffer;
                ...
                *pcchLanguagesBuffer = cchLanguagesBufferNeed;
                ...
                if (pBuffer == szLanguageNameStaticBuffer)
                {
                    ...
                    memcpy(
                        pwszLanguagesBuffer,
                        szLanguageNameStaticBuffer,
                        cchLanguagesBufferNeed * sizeof(pwszLanguagesBuffer[0]));
                }
            }
            else
            {
...
__DEFINE_THUNK(kernel32, 0, LANGID, WINAPI, GetThreadUILanguage, void)
{
