...
// Windows Server 2003 [desktop apps | UWP apps]
__DEFINE_THUNK(kernel32, 4, VOID, WINAPI, InitializeSListHead, _Out_ PSLIST_HEADER ListHead)
{
...
// Windows XP [desktop apps | UWP apps]
// Windows Server 2003 [desktop apps | UWP apps]
__DEFINE_THUNK(kernel32, 4, USHORT, WINAPI, QueryDepthSList, _In_ PSLIST_HEADER ListHead)
{
