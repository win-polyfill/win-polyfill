...
__DEFINE_THUNK(kernel32, 4, BOOL, WINAPI, Wow64DisableWow64FsRedirection, _Out_ PVOID *OldValue)
{
...
// Windows XP Professional x64 Edition, Windows Server 2003
__DEFINE_THUNK(kernel32, 4, BOOL, WINAPI, Wow64RevertWow64FsRedirection, _In_ PVOID OlValue)
{
