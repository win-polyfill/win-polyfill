...
__DEFINE_THUNK(kernel32, 4, DWORD, WINAPI, GetMaximumProcessorCount, _In_ WORD GroupNumber)
{
...
// Minimum supported client	Windows 7 [desktop apps only]
// Minimum supported server	Windows Server 2008 R2 [desktop apps only]
__DEFINE_THUNK(kernel32, 4, DWORD, WINAPI, GetActiveProcessorCount, _In_ WORD GroupNumber)
{
