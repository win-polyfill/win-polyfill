    ...
    _In_ DWORD nndPreferred)
{
    ...
    {
        return pCreateFileMappingNumaW(
            hFile,
    ...
    _In_ DWORD nndPreferred)
{
    ...
    {
        return pCreateFileMappingNumaA(
            hFile,
            lpFileMappingAttributes,
            flProtect,
            dwMaximumSizeHigh,
        ...
        for (ULONG i = 0; i != ParameterCount; ++i)
        {
            if (ExtendedParameters[i].Type == MemExtendedParameterNumaNode)
            {
                return CreateFileMappingNumaW(
                    File,
                    SecurityAttributes,
                    PageProtection | AllocationAttributes,
                    MaximumSize >> 32,
                    MaximumSize & 0xFFFFFFFF,
                    Name,
                    ExtendedParameters[i].ULong);
...
__DEFINE_THUNK(kernel32, 0, SIZE_T, WINAPI, GetLargePageMinimum, VOID)
{
