...
static OSVERSIONINFOW g_win32_osversion;
static INIT_ONCE g_win32_osversion_initonce;
static BOOL __stdcall win32_os_version_init(PINIT_ONCE InitOnce, PVOID Parameter, PVOID *lpContext)
{
    ZeroMemory(&g_win32_osversion, sizeof(OSVERSIONINFOW));
    g_win32_osversion.dwOSVersionInfoSize = sizeof(OSVERSIONINFOW);
    GetVersionExW(&g_win32_osversion);
    return TRUE;
}
static LPOSVERSIONINFOW GetOSVersion()
{
    ::wp_InitOnceExecuteOnce(&g_win32_osversion_initonce, win32_os_version_init, nullptr, nullptr);
