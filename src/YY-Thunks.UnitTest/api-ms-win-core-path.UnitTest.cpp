...
TEST_CLASS(PathIsUNCEx){public : PathIsUNCEx(){YY::Thunks::aways_null_wp_get_PathIsUNCEx = true;
}
...
TEST_CLASS(PathCchIsRoot){public :
                              PathCchIsRoot(){YY::Thunks::aways_null_wp_get_PathCchIsRoot = true;
}
...
TEST_CLASS(PathCchAddBackslashEx){
    public : PathCchAddBackslashEx(){YY::Thunks::aways_null_wp_get_PathCchAddBackslashEx = true;
}
...
TEST_CLASS(PathCchRemoveBackslashEx){public : PathCchRemoveBackslashEx(){
...
TEST_CLASS(PathCchSkipRoot){
    public : PathCchSkipRoot(){YY::Thunks::aways_null_wp_get_PathCchSkipRoot = true;
}
...
TEST_CLASS(PathCchStripToRoot){
    public : PathCchStripToRoot(){YY::Thunks::aways_null_wp_get_PathCchStripToRoot = true;
}
...
TEST_CLASS(PathCchRemoveFileSpec){
    public : PathCchRemoveFileSpec(){YY::Thunks::aways_null_wp_get_PathCchRemoveFileSpec = true;
}
...
TEST_CLASS(PathCchFindExtension){
    public : PathCchFindExtension(){YY::Thunks::aways_null_wp_get_PathCchFindExtension = true;
}
...
TEST_CLASS(PathCchAddExtension){
    public : PathCchAddExtension(){YY::Thunks::aways_null_wp_get_PathCchAddExtension = true;
}
...
TEST_CLASS(PathCchRenameExtension){
    public : PathCchRenameExtension(){YY::Thunks::aways_null_wp_get_PathCchRenameExtension = true;
}
...
TEST_CLASS(PathCchRemoveExtension){
    public : PathCchRemoveExtension(){YY::Thunks::aways_null_wp_get_PathCchRemoveExtension = true;
}
...
TEST_CLASS(PathCchCanonicalizeEx){
    public : PathCchCanonicalizeEx(){YY::Thunks::aways_null_wp_get_PathCchCanonicalizeEx = true;
}
...
TEST_METHOD(基础功能验证)
{
...

    {
        ...
        auto hr =
            ::PathCchCanonicalizeEx(Input, _countof(Input), LR"(C:\name_1\.\name_2\..\name_3)", 0);
...
TEST_METHOD(根目录向上跳转验证)
{
...

    {
        ...
        auto hr =
            ::PathCchCanonicalizeEx(Input, _countof(Input), LR"(\\path1\path2\..\file.123)", 0);
...
TEST_CLASS(PathCchCombineEx){
    public : PathCchCombineEx(){YY::Thunks::aways_null_wp_get_PathCchCombineEx = true;
}
...
{
    {
        ...
        auto hr =
            ::PathCchCombineEx(Input, _countof(Input), LR"(C:\path1\path2)", LR"(D:\path3)", 0);
...
TEST_CLASS(PathCchAppendEx){
    public : PathCchAppendEx(){YY::Thunks::aways_null_wp_get_PathCchAppendEx = true;
}
...
TEST_CLASS(PathCchStripPrefix){
    public : PathCchStripPrefix(){YY::Thunks::aways_null_wp_get_PathCchStripPrefix = true;
}
