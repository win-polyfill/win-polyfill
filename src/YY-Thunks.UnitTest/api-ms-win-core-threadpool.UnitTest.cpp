...
TEST_CLASS(SubmitThreadpoolWork){
    public : SubmitThreadpoolWork(){YY::Thunks::aways_null_wp_get_CreateThreadpoolWork = true;
...
TEST_CLASS(TrySubmitThreadpoolCallback){public : TrySubmitThreadpoolCallback(){
...
TEST_CLASS(WaitForThreadpoolWorkCallbacks){public : WaitForThreadpoolWorkCallbacks(){
...
TEST_CLASS(SetThreadpoolTimer){
    public : SetThreadpoolTimer(){YY::Thunks::aways_null_wp_get_CreateThreadpoolTimer = true;
...
TEST_CLASS(WaitForThreadpoolTimerCallbacks){public : WaitForThreadpoolTimerCallbacks(){
...
TEST_METHOD(一般行为验证)
{
    ...
    Assert::AreEqual(
        WaitForSingleObject(Data.hEvent, 1 * 1000), WAIT_OBJECT_0, L"1秒内必须完成，这是预期。");
    ...
    Assert::AreEqual(
        WaitForSingleObject(h, 30 * 1000), WAIT_OBJECT_0, L"6秒内必须完成，这是预期。");
    CloseHandle(h);
...
TEST_CLASS(SetEventWhenCallbackReturns)
{
  public:
    ...
    struct UserData
    {
        ...
        UserData() : hHandle(CreateEventW(nullptr, FALSE, FALSE, nullptr)), RunCount(0)
        {
    ...
    TEST_METHOD(任务测试)
    {
        ...
        Assert::AreEqual(
            WaitForSingleObject(Data.hHandle, 5 * 1000), WAIT_OBJECT_0, L"5秒内句柄必须有信号");
        Assert::AreEqual(Data.RunCount, 1l);
...
TEST_CLASS(ReleaseSemaphoreWhenCallbackReturns)
{
  public:
    ...
    struct UserData
    {
        ...
        UserData() : hHandle(CreateSemaphoreW(nullptr, 0, 1, nullptr)), RunCount(0)
        {
            Assert::IsNotNull(hHandle);
        }
...
TEST_CLASS(ReleaseMutexWhenCallbackReturns)
{
  public:
    ...
    struct UserData
    {
        ...
        UserData() : hHandle(CreateMutexW(nullptr, FALSE, nullptr)), RunCount(0)
        {
            Assert::IsNotNull(hHandle);
        }
...
TEST_CLASS(LeaveCriticalSectionWhenCallbackReturns)
{
  public:
    ...
    struct UserData
    {
        ...
        UserData() : bInit(false), RunCount(0)
        {
...
TEST_CLASS(FreeLibraryWhenCallbackReturns)
{
  public:
    ...
    struct UserData
    {
        ...
        UserData(HMODULE hMod) : hHandle(hMod), RunCount(0) { Assert::IsNotNull(hHandle); }
    ...
    TEST_METHOD(任务测试)
    {
        ...
        for (; i != 100; ++i)
        {
            ...
            if (GetModuleHandleExW(
                    GET_MODULE_HANDLE_EX_FLAG_UNCHANGED_REFCOUNT, NewDllPath, &hModule) == FALSE)
            {
...
TEST_CLASS(SetThreadpoolWait){
    public : SetThreadpoolWait(){YY::Thunks::aways_null_wp_get_CreateThreadpoolWait = true;
...
TEST_CLASS(WaitForThreadpoolWaitCallbacks){public : WaitForThreadpoolWaitCallbacks(){
...
{
    {
        ...
        Assert::AreEqual(
            WaitForSingleObject(h, 10 * 1000), WAIT_OBJECT_0, L"10秒内必须完成，这是预期。");
